...
document.querySelector('.button-showmore-container').addEventListener("click", loadMoreHandler);
...
document.querySelector('.header__logout').addEventListener("click", logoutHandler);

document.addEventListener('click', showLoginHandler);

document.querySelector('#cancel-login').addEventListener("click", cancelLoginHandler);

document.querySelector('.header__logo').addEventListener("click", backHomeHandler);

document.querySelector('.footer__logo').addEventListener("click", backHomeHandler);

document.addEventListener("click", goToPersonalPageHandler);

document.addEventListener("click", showOrHideSortByHandler);

document.querySelector('.sort-by__content').addEventListener("click", sortByHandler);
...
document.querySelector('#add_new').addEventListener("click", showAddNewCardHandler);

document.querySelector('#cancel-add').addEventListener("click", cancelAddNewCardHandler);

document.querySelector('#apply-add').addEventListener("click", applyAddNewCardHandler);

document.addEventListener("click", showEditPhotoPostHandler);

// document.querySelector('#cancel-edit').addEventListener("click", cancelEditPhotoPostHandler);

document.addEventListener("click", applyEditPhotoPostHandler);

// document.addEventListener("click", normalizeBody);
...
function createPhotoPost(mode, photoPost){       //create an return new cardItem without adding
  ...
  if (mode === "edit"){
    ...
    cancel.addEventListener("click", cancelEditPhotoPostHandler);
